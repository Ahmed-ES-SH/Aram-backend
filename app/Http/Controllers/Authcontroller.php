...
class Authcontroller extends Controller
{
    ...
    public function handleGoogleCallback(Request $request)
    {
        try {
            ...
            // إذا كانت الاستجابة تُطلب عبر JavaScript
            ...
            // إعادة التوجيه في حالة الوصول المباشر
            ...
            return redirect(env('FRONTEND_URL') . "/auth/callback?error=" . urlencode($e->getMessage()));
        }
    }
