...
class TermsConditionUserController extends Controller
{
    use ApiResponse;
    ...
    public function store(Request $request)
    {
        ...
        $policy = TermsConditionUser::create([
    ...
    public function update(Request $request, $id)
    {
        ...
        $policy = TermsConditionUser::findOrFail($id);
        $policy->update([
            'content_en' => $request->content_en,
            'content_ar' => $request->content_ar,
        ]);
